...
export const DEFAULT_ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    permissions: ['stores.read', 'orders.read', 'orders.automation.read', 'order_export.create', 'order_export.read', 'order_export_preset.manage', 'accounting.export', 'analytics.read', 'analytics.export', 'analytics.financial.read'],
  },
  {
    key: 'warehouse_staff',
  ...
  },
  {
    ...
    permissions: ['clients.read', 'stores.read', 'orders.read', 'orders.automation.read', 'order_export.read'],
  },
  {
    key: 'viewer',
    name: 'viewer',
