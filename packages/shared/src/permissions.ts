...
export const PERMISSIONS = [
  ...
  P('orders.automation.read', 'Otomasyon kurallarını gör', 'View order automation rules and run history', 'Sipariş & Sevkiyat'),
  P('orders.automation.manage', 'Otomasyon kurallarını yönet', 'Create, update, test and delete order automation rules', 'Sipariş & Sevkiyat'),
  P('order_export.create', 'Dışa aktarma başlat', 'Create and run order export jobs', 'Sipariş & Sevkiyat'),
  P('order_export.read', 'Dışa aktarmalarımı gör', 'View own order export jobs and download files', 'Sipariş & Sevkiyat'),
  P('order_export.read_all', 'Tüm dışa aktarmaları gör', 'View team order export jobs', 'Sipariş & Sevkiyat'),
  P('order_export.pii', 'Müşteri kişisel verilerini dışa aktar', 'Export customer personal data (PII columns)', 'Sipariş & Sevkiyat'),
  P('order_export_preset.manage', 'Dışa aktarma şablonlarını yönet', 'Create and modify export presets', 'Sipariş & Sevkiyat'),
  P('order_export_schedule.manage', 'Zamanlanmış dışa aktarımları yönet', 'Manage automated export schedules', 'Sipariş & Sevkiyat'),
  P('order_import.create', 'Siparişleri içe aktar', 'Upload, map and import orders from files', 'Sipariş & Sevkiyat'),
  P('order_import.read', 'İçe aktarma geçmişini gör', 'View order import jobs and error reports', 'Sipariş & Sevkiyat'),
  P('order_import.read_all', 'Tüm içe aktarmaları gör', 'View team order import jobs', 'Sipariş & Sevkiyat'),
  P('order_import.update_existing', 'Mevcut siparişleri güncelle', 'Update or upsert existing orders from file', 'Sipariş & Sevkiyat'),
  P('order_import.rollback', 'İçe aktarmayı geri al', 'Rollback imported or updated orders within 24 hours', 'Sipariş & Sevkiyat'),
  P('order_import_mapping.manage', 'Eşleştirme şablonlarını yönet', 'Create and modify order import mapping templates', 'Sipariş & Sevkiyat'),
  P('order_settings.read', 'Sipariş ayarlarını gör', 'View order settings and change history', 'Sipariş & Sevkiyat'),
  P('order_settings.update', 'Sipariş ayarlarını düzenle', 'Update order settings', 'Sipariş & Sevkiyat'),
  P('order_settings.update_sensitive', 'Hassas sipariş ayarlarını düzenle', 'Update sensitive order settings (numbering, invoice, retention)', 'Sipariş & Sevkiyat'),
  P('order_settings.lock', 'Sipariş ayarlarını kilitle', 'Lock or unlock order settings for lower hierarchy levels', 'Sipariş & Sevkiyat'),
...
export const DEFAULT_ROLES: RoleDef[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'orders.read', 'orders.update', 'orders.cancel', 'orders.automation.read', 'orders.automation.manage',
      ...
      'order_export.create', 'order_export.read', 'order_export.read_all', 'order_export.pii', 'order_export_preset.manage', 'order_export_schedule.manage',
      'order_import.create', 'order_import.read', 'order_import.read_all', 'order_import.update_existing', 'order_import.rollback', 'order_import_mapping.manage',
      'order_settings.read', 'order_settings.update', 'order_settings.update_sensitive', 'order_settings.lock',
    ],
  },
  {
    key: 'agency_admin',
  ...
  },
  {
    ...
    permissions: [
      ...
      'order_export.create', 'order_export.read', 'order_export.read_all', 'order_export.pii', 'order_export_preset.manage', 'order_export_schedule.manage',
      'order_import.create', 'order_import.read', 'order_import.read_all', 'order_import.update_existing', 'order_import.rollback', 'order_import_mapping.manage',
      'order_settings.read', 'order_settings.update', 'order_settings.lock',
    ],
  },
  {
    key: 'store_manager',
    ...
    permissions: [
      ...
      'order_export.create', 'order_export.read', 'order_export.pii', 'order_export_preset.manage',
      'order_import.create', 'order_import.read', 'order_import.update_existing', 'order_import_mapping.manage',
      'order_settings.read', 'order_settings.update',
    ],
  },
  {
    key: 'accountant',
    ...
    permissions: ['stores.read', 'orders.read', 'orders.automation.read', 'order_export.create', 'order_export.read', 'order_export_preset.manage', 'order_import.read', 'accounting.export', 'analytics.read', 'analytics.export', 'analytics.financial.read'],
  },
  {
    key: 'warehouse_staff',
  ...
  },
  {
    ...
    permissions: ['clients.read', 'stores.read', 'orders.read', 'orders.automation.read', 'order_export.read', 'order_import.read'],
  },
  {
    key: 'viewer',
    name: 'viewer',
