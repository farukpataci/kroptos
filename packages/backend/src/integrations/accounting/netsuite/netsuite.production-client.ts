...
/**
 * NetSuite PRODUCTION İstemcisi (§1, §6, §10)
 * Bu turda MOCK_READY hedeflendiği için PRODUCTION ortamında hiçbir gerçek ağ çağrısı yapılmaz.
 */
export class NetSuiteProductionClient implements INetSuiteClient {
  private guard(): never {
    throw new IntegrationNotVerifiedError('netsuite', 'PRODUCTION');
  }
