...
/**
 * Adapter allowing T-Soft to be consumed through the MarketplaceConnector
 * interface whenever a caller queries MarketplaceConnectorFactory.
 */
export class TsoftMarketplaceAdapter extends MarketplaceConnector {
  private readonly delegate: TsoftConnector;
  ...
  constructor(
    ...
    this.delegate = new TsoftConnector(credentials, ecommerceHttpClient, ecommerceRateLimiter, settings);
  }
