...
/**
 * Adapter allowing Ticimax to be consumed through the MarketplaceConnector
 * interface whenever a caller queries MarketplaceConnectorFactory.
 */
export class TicimaxMarketplaceAdapter extends MarketplaceConnector {
  private readonly delegate: TicimaxConnector;
  ...
  constructor(
    ...
    this.delegate = new TicimaxConnector(credentials, ecommerceHttpClient, ecommerceRateLimiter, settings);
  }
