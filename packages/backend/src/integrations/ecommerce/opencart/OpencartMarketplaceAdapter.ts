...
/**
 * Adapter allowing OpenCart to be consumed through the MarketplaceConnector
 * interface whenever a caller queries MarketplaceConnectorFactory.
 */
export class OpencartMarketplaceAdapter extends MarketplaceConnector {
  private readonly delegate: OpencartConnector;
  ...
  constructor(
    ...
    this.delegate = new OpencartConnector(credentials, ecommerceHttpClient, ecommerceRateLimiter, settings);
  }
