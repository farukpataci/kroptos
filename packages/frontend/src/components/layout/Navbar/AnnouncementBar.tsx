      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex-1 flex items-center justify-center">
          <p className="text-xs sm:text-sm font-medium text-white tracking-wide text-center">
            🚀 <span className="font-semibold text-kp-accent">Alqora</span> {isTr ? 'ile tüm e-ticaret operasyonlarınızı tek merkezden yönetin.' : 'allows you to manage all e-commerce operations from a single center.'}
          </p>
        </div>
        <button
          onClick={handleClose}
