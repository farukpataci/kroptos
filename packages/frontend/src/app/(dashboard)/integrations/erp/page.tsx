    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between border-b border-kp-border pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-kp-text-primary">ERP Integrations</h1>
            <p className="text-[13px] text-kp-text-tertiary">Connect ERP software platforms for automated synchronization</p>
          </div>
        </div>
        <button
