  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="text-center max-w-xl mx-auto">
        ...
        <p className="mt-2 text-[0.8125rem] text-kp-text-tertiary leading-relaxed">
        ...
        <div className="mt-6 relative max-w-md mx-auto">
          <input
            ...
            className="w-full rounded-kp-lg border border-kp-border bg-kp-bg-secondary px-4 py-3 pl-10 text-[0.8125rem] text-kp-text-primary placeholder-kp-text-tertiary transition-colors focus:border-kp-border-accent focus:outline-none shadow-kp-card"
          />
        ...
        {menuItems.map((item) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[0.875rem] font-semibold text-kp-text-primary group-hover:text-kp-accent-hover transition-colors">
                {item.title}
              </h3>
            </div>
            <p className="text-[0.75rem] text-kp-text-tertiary leading-relaxed">{item.description}</p>
          </Link>
        ))}
      </div>
    </div>
